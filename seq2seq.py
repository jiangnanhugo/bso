...
class Seq2Seq(object):
    def __init__(self, envocab_size, devocab_size, n_hidden, rnn_cells=None,
        ...
        self.dec_imask = T.fmatrix('decoder mask')
        self.dec_output = T.imatrix('decoder input mask')
        self.dec_omask = T.fmatrix('decoder output mask')
    ...
    def build_graph(self):
        ...
        cost,acc = self.categorical_crossentropy(output_layer, self.dec_output, self.dec_omask)
