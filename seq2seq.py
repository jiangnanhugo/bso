...
class Seq2Seq(object):
    ...
    def build_dec(self):
        ...
        self.train = theano.function(inputs=[self.enc, self.enc_mask,
                                             dec_input, dec_output, dec_mask, lr],
                                     outputs=[cost, acc],
                                     updates=updates,
